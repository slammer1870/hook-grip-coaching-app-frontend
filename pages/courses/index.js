    ...
    return (
        <div>
            <div className="flex flex-col p-6">
                ...
                <p className="mb-4">These courses are sample courses and the Stripe Checkout is in test mode. If you wish to view a course you can make a test purchase by using:</p>
                ...
                {categories.map((category) => (
                    <div className="overflow-y-hidden" key={category.id}>
                        ...
                        <div className="flex overflow-y-scroll bg-gradient-to-r to-white z-10">
                            {courses
                                .filter((course) => course.course_category.title == category.title)
                                .map((course) => (
                                    <div
                                        className="flex flex-col justify-center items-center mr-4" key={course.id}>
